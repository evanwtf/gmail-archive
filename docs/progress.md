...
**Current position: Phase 1 complete. Phase 2 (fixture generator) not started.**
...
Four commits, pushed straight to `main`.
...
Phases 2–10, as scoped in [plan.md](plan.md). Phase 2 (the synthetic mbox
fixture generator) is next and is load-bearing: nothing downstream can be
